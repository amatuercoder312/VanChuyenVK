...
function [CurrentBoid, Boids] = Move_Seek_Formations(Target, Weight, Boids, CurrentBoid, Leader, AfterLeader, BoidIndex)
global FleeDistance;
...
force = force + steer_pursue(CurrentBoid, p_following);
