...
%%stone 1
    ...
    ObstaclesPlot= image(Obstacles(21,1)+200, Obstacles(1,2)+500, img_i);
...
%%stone 2
    ...
    ObstaclesPlot= image(Obstacles(22,1)+150, Obstacles(2,2)+500, img_i);
    ObstaclesPlot.AlphaData = alpha_i;   
%%stone 3
    angle = 0;	% imrotate rotates ccw     
    img_i = imrotate(v_ImageS3, angle);
    alpha_i = imrotate(v_AlphaS3, angle );
    ObstaclesPlot= image(Obstacles(23,1)+400, Obstacles(3,2)+200, img_i);
    ObstaclesPlot.AlphaData = alpha_i;   
%%stone 4
    angle = 0;	% imrotate rotates ccw     
    img_i = imrotate(v_ImageS4, angle);
    alpha_i = imrotate(v_AlphaS4, angle );
    ObstaclesPlot= image(Obstacles(24,1)+500, Obstacles(4,2)+150, img_i);
    ObstaclesPlot.AlphaData = alpha_i;  
%%stone 5
    angle = 0;	% imrotate rotates ccw     
    img_i = imrotate(v_ImageS5, angle);
    alpha_i = imrotate(v_AlphaS5, angle );
    ObstaclesPlot= image(Obstacles(25,1)+500, Obstacles(5,2)+150, img_i);
    ObstaclesPlot.AlphaData = alpha_i; 
%%stone 6
    angle = 0;	% imrotate rotates ccw     
    img_i = imrotate(v_ImageS6, angle);
    alpha_i = imrotate(v_AlphaS6, angle );
    ObstaclesPlot= image(Obstacles(26,1)+700, Obstacles(6,2)+200, img_i);
    ObstaclesPlot.AlphaData = alpha_i;  
